...
namespace Discount.Grpc.Services
{
    public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        {
            repository = discountRepository ?? throw new ArgumentNullException(nameof(discountRepository));
        ...
        {
            var deleted = await repository.DeleteDiscount(request.Coupon.ProductName);
